"""Build the frozen S4 source-only task exposure; does not start training."""
import argparse
import hashlib
import json
...
TASK_SHA = '663e76794901e0af31d759a027ab4ea1e300888fb55e1927691336e2e4f4916b'
...
def main():
    ...
    for r in tasks:
        t = r['task']
        cases.append(dict(dataset='s4_condition_training', source_id=r['id'], category=r['family'],
    ...
    manifest = dict(arm='S4', lr=5e-7, batch_size=3, steps=77, epochs=1, train=audit,
