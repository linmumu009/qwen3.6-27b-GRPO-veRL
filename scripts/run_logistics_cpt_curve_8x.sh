...
RUN_NAME="${RUN_NAME:-logistics-cpt-book-exposure-curve-8x-20260910-01}"
...
purpose=single_book_cpt_exposure_curve_0_to_8
...
optimizer_state=fresh_continuous_through_step_232
...
expected_total_sequence_tokens_with_eos=2693616
train_batch_size=${TRAIN_BATCH_SIZE}
total_training_steps=${TOTAL_STEPS}
evaluation_checkpoints=0,29,58,87,116,145,174,203,232
evaluation_exposures=0,1,2,3,4,5,6,7,8
...
optimizer_checkpoint_saved=true
