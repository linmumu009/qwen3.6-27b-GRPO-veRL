...
数据：datasets/GRPO/train.jsonl和val.jsonl；入口自动转换Parquet。
输出：outputs/GRPO/时间编号/，包括driver.log、exit_code、preflight.json、resolved_config.yaml、status.json和checkpoints。
